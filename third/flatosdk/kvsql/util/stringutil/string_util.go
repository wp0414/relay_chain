...
// CompilePattern is a plugin for `CompilePatternInner`, `pattern` can be any unicode string.
...
// DoMatch is a plugin for `DoMatchInner`, `str` can be any unicode string.
